...
protected:
	...
	afx_msg LRESULT OnWRURL(WPARAM wParam, LPARAM lParam); 	
	//}}AFX_MSG
	...
	afx_msg void ONOpenWebsite(UINT nID);
	DECLARE_MESSAGE_MAP()
public:
	void updataTaskString(CString str);
	afx_msg void OnPicBar();
	afx_msg void OnUpdatePicBar(CCmdUI *pCmdUI);
	// 显示output内容
	bool outputString(CString& str);
	afx_msg void OnClose();
	//自定义消息

	afx_msg void OnIndicatorLabel();
	afx_msg void OnLink8564Com();
};
